...
export class MindMap {
    ...
    updateZoom() {
        ...
        // Base width is 100%, which fills viewport. Min-width is dynamically adjusted.
        this.image.style.width = this.zoomPercent + '%';
        
        if (this.zoomPercent === 100) {
            this.image.style.minWidth = '1200px'; // ensure detailed readability at default
        } else {
            this.image.style.minWidth = 'none';
        }
    }
